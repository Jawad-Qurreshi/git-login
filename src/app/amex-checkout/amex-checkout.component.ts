...
@Component({
  selector: 'app-amex-checkout',
  templateUrl: './amex-checkout.component.html',
  styleUrls: ['./amex-checkout.component.css']
})
export class AmexCheckoutComponent implements OnInit {
